...
module grove16x2lcdFaceplate()
{
	...
	difference()
	{
		union()
		{
			...
			color( "black" ) translate( [-10,41.5,6] ) cube( [60,1,2] );
		...
		//translate( [12-padding/2,42,5] ) cube( [(grove16x2lcdDisplayHeight+padding)/2,(grove16x2lcdDisplayWidth+padding)/2,8] );

	}

	color( "red" ) rotate( [0,0,0] ) translate( [grove16x2lcdHeight-2,grove16x2lcdWidth-2,1] ) nutM2( additionalHeight=2, additionalDiameter=0 );
